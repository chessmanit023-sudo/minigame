...
export class CameraFollow extends Component {
    ...
    private _changeCameraType(type: number) {
        ...
        switch (type) {
            ...
            case gameConstants.CAMERA_TYPE_LIST.REWARD:
                ...
                break;
            case gameConstants.CAMERA_TYPE_LIST.CELEBRATE:
                this.ndTarget = GameManager.scriptPlayer.node;
                this.offsetPos = gameConstants.CAMERA_CELEBRATE_DATA.offsetPosInit;
                this.offsetLookAtPos = gameConstants.CAMERA_CELEBRATE_DATA.offsetLookAtPos;
                break;
    ...
    lateUpdate(dt: number) {
        ...
        if (this.cameraType === gameConstants.CAMERA_TYPE_LIST.READY_TO_PLAYING) {
            ...
            lerpPosNum = 0.2;
            lerpEulNum = 0.2;
        } else if (this.cameraType === gameConstants.CAMERA_TYPE_LIST.CELEBRATE) {
            lerpPosNum = 0.08;
            lerpEulNum = 0.08;
        }
