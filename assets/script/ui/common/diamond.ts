...
export class Diamond extends Component {
    ...
    onEnable() {
        clientEvent.on(gameConstants.CLIENTEVENT_LIST.REFRESH_DIAMOND, this._refreshDiamond, this);
    }

    onDisable() {
        clientEvent.off(gameConstants.CLIENTEVENT_LIST.REFRESH_DIAMOND, this._refreshDiamond, this);
    }
